...
inline std::string_view nl80211_attr_string(nl80211_attrs attr)
{
	switch (attr) {
		...
		case NL80211_ATTR_WIPHY_RADIOS: return "NL80211_ATTR_WIPHY_RADIOS";
		case NL80211_ATTR_WIPHY_INTERFACE_COMBINATIONS: return "NL80211_ATTR_WIPHY_INTERFACE_COMBINATIONS";
#endif

#if LINUX_VERSION_CODE >= KERNEL_VERSION(6, 16, 0)
		case NL80211_ATTR_VIF_RADIO_MASK: return "NL80211_ATTR_VIF_RADIO_MASK";
		case NL80211_ATTR_SUPPORTED_SELECTORS: return "NL80211_ATTR_SUPPORTED_SELECTORS";
		case NL80211_ATTR_MLO_RECONF_REM_LINKS: return "NL80211_ATTR_MLO_RECONF_REM_LINKS";
		case NL80211_ATTR_EPCS: return "NL80211_ATTR_EPCS";
		case NL80211_ATTR_ASSOC_MLD_EXT_CAPA_OPS: return "NL80211_ATTR_ASSOC_MLD_EXT_CAPA_OPS";
#endif
...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(6, 16, 0)
		case NL80211_CMD_ASSOC_MLO_RECONF: return "NL80211_CMD_ASSOC_MLO_RECONF";
		case NL80211_CMD_EPCS_CFG: return "NL80211_CMD_EPCS_CFG";
#endif
